...
def temp_project(tmp_path):
    ...
    # Create grai.yml
    (project_dir / "grai.yml").write_text("""name: test-project
version: 1.0.0
""")
    ...
    (entities_dir / "customer.yml").write_text("""entity: customer
source: customers
keys: [id]
properties:
  - name: name
...
""")
    ...
    (relations_dir / "purchased.yml").write_text("""relation: PURCHASED
from: customer
to: product
source: orders
""")
...
class TestChangeDetection:
    ...
    def test_get_changed_files_modified(self, temp_project):
        ...
        # Modify a file
        (temp_project / "entities" / "customer.yml").write_text("""entity: customer
source: customers_v2
keys: [id]
""")
    ...
    def test_get_changed_files_added(self, temp_project):
        ...
        # Add new file
        (temp_project / "entities" / "product.yml").write_text("""entity: product
source: products
keys: [id]
""")
...
class TestUpdateCache:
    ...
    def test_update_cache_replaces_old(self, temp_project):
        ...
        cache1 = update_cache(temp_project, "old-name", "1.0.0")
