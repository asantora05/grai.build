...
- **Schema migrations** - Version-controlled schema evolution with automatic change detection
...
- [Schema Migrations](MIGRATIONS.md) - Version-controlled schema evolution
...
````
>>>>>>> fdcf9ac (docs: add comprehensive migration system documentation)
