...
def main():
    ...
    print(f"✓ Generated D3 visualization")
    print(f"  File: {d3_output}")
    print(f"  Size: {d3_output.stat().st_size:,} bytes")
    print(f"  Format: Interactive HTML with D3.js force-directed graph")
    print(f"\nFeatures:")
    print(f"  • Drag nodes to rearrange")
    print(f"  • Hover for tooltips")
    print(f"  • Physics-based layout")
    ...
    print(f"✓ Generated Cytoscape visualization")
    print(f"  File: {cytoscape_output}")
    print(f"  Size: {cytoscape_output.stat().st_size:,} bytes")
    print(f"  Format: Interactive HTML with Cytoscape.js")
    print(f"\nFeatures:")
    print(f"  • Click nodes for details")
    print(f"  • Hierarchical layout")
    print(f"  • Bezier curves for edges")
    print(f"  • Shape-based node types")
    ...
    print(f"✓ Generated custom-sized visualization")
    print(f"  Dimensions: 800x600 pixels")
    print(f"  Perfect for embedding in dashboards")
    ...
    print(f"   {d3_output}")
    print(f"   Best for: Exploring relationships dynamically")
    
    print(f"\n2. Cytoscape.js Network")
    print(f"   {cytoscape_output}")
    print(f"   Best for: Detailed network analysis")
    
    print(f"\n3. Custom Dimensions")
    print(f"   {custom_output}")
    print(f"   Best for: Embedded views")
