...
from grai.core.models import Entity, Property, PropertyType, SourceConfig, SourceType
...
class DbtManifestParser:
    ...
    def parse_models(
        ...
        """
        Parse dbt models into grai.build entities.
        ...
        Returns:
            List of Entity objects generated from dbt models.
        """
        entities = []
    ...
    def _parse_columns(self, columns: Dict[str, Any]) -> List[Property]:
        ...
        for col_name, col_data in columns.items():
            ...
            dbt_type = col_data.get("data_type", "string").lower()
...
def parse_dbt_manifest(manifest_data: Dict[str, Any]) -> List[Entity]:
    """
    Parse dbt manifest data into grai.build entities.
    ...
    Example:
        ...
        >>> entities = parse_dbt_manifest(manifest)
...
def parse_dbt_manifest_file(
    ...
    """
    Parse a dbt manifest.json file into grai.build entities.
...
def write_entities_to_yaml(
    ...
    for entity in entities:
        ...
        entity_dict = {
            ...
            "source": (
                entity.source.model_dump(exclude_none=True)
