...
def should_rebuild(project_dir: Path, cache: Optional[BuildCache] = None) -> tuple[bool, Dict[str, Set[Path]]]:
    """
...
def update_cache(project_dir: Path, project_name: Optional[str] = None, 
                 project_version: Optional[str] = None) -> BuildCache:
    """
